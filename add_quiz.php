  ...
  <!-- Navbar -->
      ...
      <div class="row">
        ...
        <div class="col-sm-8">
              ...
              <div class="col-sm-8">
              <h1 class="w3-text-teal">Add Quiz</h1><br>
              <form class="form-inline" name="createquiz" method="post" action="add_quiz_save.php">
                <div class="form-group">
                   <font color="white"> Question: </font><input type="text" class="form-control" id="quiz" name="quiz" placeholder="Enter Question" size="74"><p><p>
                    ...
                    ?> 
                    <br>
                    <button type="submit" class="btn btn-default" name = "n_eID" value="<?php echo $n_eID;?>">Confirm</button>
                </div>
              </form>
